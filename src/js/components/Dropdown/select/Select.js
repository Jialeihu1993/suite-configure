...
const Select = React.createClass({
	...
	propTypes: {
		...
		onScrollMenu: React.PropTypes.func,			// Menu is scrolled
	...
	renderOuter(options, valueArray, focusedOption) {
		...
		if(menu && menu.length>3) {
			menu = (<Scrollbars ref={item=>this.menuScrollbar=item} style={{ height: 120 }} hideTracksWhenNotNeeded={true} renderTrackVertical={renderTrackVerticalDefault} renderThumbVertical={renderThumbVerticalDefault}>
					<div style={{ paddingRight: 20 }}>{menu}</div>
				</Scrollbars>);
		}


		return (<div ref={ref => this.menuContainer = ref} className="Select-menu-outer" style={this.props.menuContainerStyle}>
